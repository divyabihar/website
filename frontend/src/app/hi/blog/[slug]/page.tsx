            ...
            <header className="pt-32 pb-16 bg-neutral-50 border-b">
                <div className="container mx-auto px-4 max-w-5xl text-center">
                    ...
                    <div className="flex items-center justify-center gap-6 text-gray-500 text-sm mb-8">
                        <span>{post.published_at ? new Date(post.published_at).toLocaleDateString('hi-IN') : 'अभी'}</span>
                        <span>•</span>
                    ...
                    <article className="lg:col-span-8">
                        ...
                        {post.faq_schema && (
                            <div className="mt-12 pt-12 border-t">
                                <h3 className="text-2xl font-bold font-serif mb-6">अक्सर पूछे जाने वाले प्रश्न (FAQ)</h3>
