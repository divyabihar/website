export const destinationsSeedData = [
  {
    name: 'Bodh Gaya',
    slug: 'bodh-gaya',
    overview:
    ...
    how_to_reach:
      'Nearest airport is Gaya Airport (12km). Patna Airport is 110km away. Well connected by rail and road.',
    best_time_to_visit: 'October to March',
    latitude: '24.6961',
    longitude: '84.9870',
    images: [
      '/images/destinations/bodh-gaya-1.jpg',
      '/images/destinations/bodh-gaya-2.jpg',
    ],
  },
  {
    name: 'Rajgir',
    ...
    history:
      'Rajgir was the first capital of the kingdom of Magadha. It dates back to 1000 BC. It is sacred to both Buddhists and Jains.',
    how_to_reach:
      'Nearest airport is Patna (100km). Rajgir has its own railway station.',
    best_time_to_visit: 'October to March',
    latitude: '25.0194',
    longitude: '85.4184',
    images: [
      '/images/destinations/rajgir.jpg',
    ],
  },
  {
    name: 'Nalanda',
    ...
    history:
      'Founded in the 5th century CE, Nalanda attracted scholars from as far as China, Korea, and Central Asia.',
    how_to_reach:
      '90km from Patna. Nearest railway station is Nalanda, but Rajgir (12km) is better connected.',
    best_time_to_visit: 'October to March',
    latitude: '25.1288',
    longitude: '85.4475',
    images: [
      '/images/destinations/nalanda.jpg',
    ],
  },
  {
    name: 'Vaishali',
    ...
    history:
      'Lord Mahavira was born here. Buddha preached his last sermon here.',
    how_to_reach: '55km from Patna.',
    best_time_to_visit: 'October to March',
    latitude: '25.9906',
    longitude: '85.1246',
    images: [
      '/images/destinations/vaishali.jpg',
    ],
  },
  {
    name: 'Patna Sahib',
    ...
    how_to_reach:
      'Located in Patna city, well connected by air, rail, and road.',
    best_time_to_visit: 'November to February',
    latitude: '25.6080',
    longitude: '85.2307',
    images: [
      '/images/destinations/patna-sahib.jpg',
    ],
  },
  {
    name: 'Gaya Ji',
    ...
    history:
      'Ancient city mentioned in Ramayana and Mahabharata. Key place for Pind Daan.',
    how_to_reach: 'Has its own international airport and railway station.',
    best_time_to_visit: 'September to March',
    latitude: '24.7914',
    longitude: '85.0002',
    images: [
      '/images/destinations/gaya-ji.jpg',
    ],
  },
  {
    name: 'Pawapuri',
    ...
    history:
      'It is the place where Mahavira attained Nirvana (salvation) in 527 BCE.',
    how_to_reach: '100km from Patna. 20km from Rajgir.',
    best_time_to_visit: 'October to March',
    latitude: '25.0934',
    longitude: '85.5348',
    images: [
      '/images/destinations/pawapuri.jpg',
    ],
  },
];
