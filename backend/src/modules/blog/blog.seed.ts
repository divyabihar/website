...
export const blogSeedData = [
  // 1. Bodh Gaya Guide (EN)
  {
    ...
    meta_description:
      'Plan your trip to Bodh Gaya with our complete guide. Learn about Mahabodhi Temple timings, history, the Bodhi Tree, and how to reach.',
    keywords: [
  ...
  // 1. Bodh Gaya Guide (HI)
  {
    language: BlogLanguage.HI,
    group_id: 'group-1',
    ...
    meta_description:
      'बोधगया की अपनी यात्रा की योजना बनाएं। महाबोधि मंदिर के समय, इतिहास, बोधि वृक्ष और पहुंचने के तरीके के बारे में जानें।',
  ...
  // 2. Pind Daan (EN)
  {
    ...
    meta_description:
      'Learn how to perform Pind Daan in Gaya Ji. Understand the rituals, significance, best time to visit, and costs involved.',
  ...
  // 2. Pind Daan (HI)
  {
    ...
    meta_description:
      'गया जी में पिंड दान कैसे करें, इसकी जानकारी प्राप्त करें। अनुष्ठानों, महत्व, यात्रा के सर्वोत्तम समय और खर्च के बारे में जानें।',
  ...
  // 3. Nalanda (EN)
  {
    ...
    meta_description:
      'Visit the ancient Nalanda University ruins. Discover the history of this great center of learning and what to see today.',
  ...
  // 3. Nalanda (HI)
  {
    ...
    meta_description:
      'प्राचीन नालंदा विश्वविद्यालय के खंडहरों की यात्रा करें। इस महान शिक्षा केंद्र के इतिहास और आज देखने लायक चीजों के बारे में जानें।',
