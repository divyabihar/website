...
const spiritual_place_entity_1 = require("./entities/spiritual-place.entity");
...
exports.DestinationsModule = DestinationsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([destination_entity_1.Destination, spiritual_place_entity_1.SpiritualPlace])],
